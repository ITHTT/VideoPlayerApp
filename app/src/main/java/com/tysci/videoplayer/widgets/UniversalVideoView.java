...
//                mMediaPlayer.setAudioStreamType(mAudioSession);
//            } else {
...
*/
    ...
    public interface VideoViewCallback {
        ...
        void onPause(final IMediaPlayer mediaPlayer);
        void onStart(final IMediaPlayer mediaPlayer);
        void onBufferingStart(final IMediaPlayer mediaPlayer);
        void onBufferingEnd(final IMediaPlayer mediaPlayer);
    }
